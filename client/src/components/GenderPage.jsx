...
const GenderPage = () => {
  ...
  return (
    <div className="h-screen flex flex-col items-center justify-between bg-white pb-20 animate-fadeIn">
      ...
      <div className="w-full flex flex-col items-center px-4 py-8 bg-white">
        <h1 className="text-3xl sm:text-5xl font-bold text-black mb-2 text-center">
        ...
        >
          {["male", "female", "notsay"].map((gender) => (
            <label
              key={gender}
              className={`
                flex items-center space-x-2 sm:space-x-3 text-sm sm:text-base text-gray-700 cursor-pointer
